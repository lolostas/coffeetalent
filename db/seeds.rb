...
user24 = User.create!(email: 'alain@orange.fr', password: 'password', first_name: 'Alain', last_name: 'Marceau', address: '4, ch. du loup 01000 Bourg en Bresse', birthday: '30/06/19')
...
talent23 = Talent.create!(talent_proposed: 'German Teacher', description: 'Hello,',category: school, meeting: true, lesson: false, user: user23)
...
talent33 = Talent.create!(talent_proposed: 'Japonese Teacher', description: 'Hello,',category: school, meeting: true, lesson: false, user: user33)
talent34 = Talent.create!(talent_proposed: 'Russian Teacher', description: 'Hello,',category: school, meeting: true, lesson: false, user: user34)
talent35 = Talent.create!(talent_proposed: 'Polish Teacher', description: 'Hello,',category: school, meeting: true, lesson: false, user: user35)
talent36 = Talent.create!(talent_proposed: 'Chinese Teacher', description: 'Hello,',category: school, meeting: true, lesson: false, user: user36)

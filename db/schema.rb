...
ActiveRecord::Schema.define(version: 20170822140240) do
  ...
  create_table "appointments", force: :cascade do |t|
    ...
    t.index ["creator_id"], name: "index_appointments_on_creator_id", using: :btree
    t.index ["destinator_id"], name: "index_appointments_on_destinator_id", using: :btree
  end
  ...
  create_table "talents", force: :cascade do |t|
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["category_id"], name: "index_talents_on_category_id", using: :btree
    t.index ["user_id"], name: "index_talents_on_user_id", using: :btree
  end
  ...
  add_foreign_key "appointments", "users", column: "destinator_id"
  ...
  add_foreign_key "talents", "categories"
